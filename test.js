...
function compute() {
  ...
  if (!num) {
    ...
    leftt140.innerHTML = "<br>levels to 140: <br>done! congrats! :]";
  ...
  function calc100() {
    leftt100.innerHTML = "<br>levels to 100: <br>" + (100 - num);
    dayz100.innerHTML = "<br><br>daily levels to stay on track: <br>" + Math.round((100 - num) / remainingDays * 100.0) / 100.0;
}
  function calc140() {
    leftt140.innerHTML = "<br>levels to 140: <br>" + (140 - num);
    dayz140.innerHTML = "<br><br>daily levels to stay on track: <br>" + Math.round((140 - num) / remainingDays * 100.0) / 100.0;
}
  function calc200() {
    leftt200.innerHTML = "<br>levels to 200: <br>" + (200 - num);
